...
<div class="col-start-2 col-end-2 space-y-4 p-2 sm:p-2 md:space-y-6">
	...
	<Stepper buttonCompleteLabel="Start Experiment" on:complete={onComplete}>
		<Step>
			<p>
				Welcome to our study on understanding the decision process of Artificial Intelligence (AI)
				models which takes about 20 minutes. It is designed as part of a large research project that
				seeks to improve understanding between AI Systems (i.e. Machine learning models) and humans.<br
				/>
			</p>
		...
		<Step locked={!consent_given}>
			...
			<div style="display: flex; align-items: center;">
				<label for="consent" style="margin-right: 10px;"
					>I read and understood the consent form and agree to participate in the study.</label
				>
		...
		<Step>
			...
			<p>
				...
				particularly in diagnosing chronic diseases like diabetes? This is where the innovative
				world of machine learning shows its true potential. <br /><br />

				In this exploration, you will discover how machine learning models are employed to analyze
				extensive health data to predict the likelihood of diabetes in individuals. These models act
				as high-tech analysts, scrutinizing a person's medical history and lifestyle factors to make
				accurate diagnoses.
				<br /><br />

				By examining variables such as age, weight and blood sugar levels, these AI systems identify
				patterns and can now more accurately predict the risk of diabetes in patients, aiding in
				early detection and management of the condition.<br />
		...
		<Step>
			...
			<p>The model would give the prediction that this person is unlikely to have diabetes.</p>
		</Step>
		<Step>
			...
			<p>
				...
				1. You will be shown one patient at a time, and your task is to make an initial guess about how
				the ML model would decide for that person. <br />
				...
				3. After you had time to understand the prediction, the next step requires you to say how
				the model will predict for a new patient. <br />
				...
				Here, the goal isn't to be right about whether someone has diabetes or not. It's all about
				estimating what the model would predict based on the explanations you see.
				<br /><br />
			</p>
		</Step>
		<Step>
			<p>
				...
				of participants and the representativeness of the study. <br /><br />

				Personal information (questions 1-4) will not be used to evaluate the results. It will be
				anonymized and randomized, so that there is no way to link it back to you and your answers
				in the study.
			...
			<div class="grid grid-cols-2 gap-8">
				...
				<label for="familiarityDomain">
					<span> 6) What is your level of familiarity with the topic of diabetes diagnose? </span>
