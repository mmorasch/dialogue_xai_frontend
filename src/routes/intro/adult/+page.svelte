...
<div class="col-start-2 col-end-2 space-y-4 p-2 sm:p-2 md:space-y-6">
    ...
    <Stepper buttonCompleteLabel="Start Experiment" on:complete={onComplete}>
        ...
        <Step>
            <h2 class="text-2xl">
                Experiment topic: Understanding AI predictions in income prediction
            </h2>
            <p>
                ...
                machine learning can be used to recognize patterns from <br/><br/>
        ...
        <Step>
            ...
            <div class="container">
                ...
                <ol>
                    ...
                    <li><b style="color: purple;">Testing Phase:</b> Guess the model prediction for a new patient based
                        on your
